...
def test_firmware_is_a_library_by_project_and_branch_not_a_growing_list():
    ...
    # A run's page says what it took, when its rig measured it.
    took = script.split("function runMetrics(", 1)[1].split("\n}\n", 1)[0]
...
PORTAL_ONLY_IDS = {
    ...
    "platform-projects", "platform-project-totals",
    "platform-runs", "platform-run-totals", "platform-run-range", "platform-runs-prev", "platform-runs-next",
    "rig-select", "rig-hint",
